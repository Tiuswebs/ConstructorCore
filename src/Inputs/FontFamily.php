...
class FontFamily extends Select
{
	...
	public function getFonts()
	{
		return collect([
			...
			Font::make('Lato')->url('https://fonts.googleapis.com/css2?family=Lato&display=swap'),
			Font::make('Bebas Neue')->url('https://fonts.googleapis.com/css2?family=Bebas+Neue&display=swap'),
			Font::make('Texturina')->url('https://fonts.googleapis.com/css2?family=Texturina&display=swap'),
			Font::make('Montserrat')->url('https://fonts.googleapis.com/css2?family=Montserrat&display=swap')
		]);
	}
}
